...
function SignIn(props) {
    ...
    const onSubmmit = formProps => {
        if (formProps.email === 'admin@gmail.com' && formProps.password === 'admin') {
            history.push('/home', { emailLogin: formProps.email});
        } else {
            var commonData = [{ type: 'error', msg: 'Incorrect username or password', open: true }];
            ...
            <div className="commonSpace">
                ...
                <div>
                    <div className="col-md-4 leftSpace">
                        <Field required name="email" component={InputField} label="Email Address" validate={isEmail} />
                    </div>
                    <div className="col-md-4 leftSpace">
                        <Field
                            name="password"
